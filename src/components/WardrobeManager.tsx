...
export const WardrobeManager: React.FC<WardrobeManagerProps> = ({
  ...
  const handleBatchAiAutoTagging = async () => {
    ...
    setBatchAiProgress({
      ...
      currentName: 'Gemini 3.7 AI 비전 일괄 태깅 준비 중...',
    });
    setAiSuccessMsg(null);
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.success && Array.isArray(data.results)) {
          ...
          setAiSuccessMsg(`Gemini 3.7 AI가 ${itemsToAnalyze.length}벌의 의류 속성을 모두 자동 분석·태깅했습니다!`);
        }
      } else {
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <h4 className="text-base sm:text-lg text-[#20304A] dark:text-white font-bold">
                    의류 다중 일괄 등록 & Gemini 3.7 AI 자동 비전 태깅
                  </h4>
                </div>
              </div>
              <button
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="text-xs">
                  ...
                  <span className="text-gray-600">
                    대기열의 모든 의류 사진을 Gemini 3.7 AI가 한 번에 스캔하여 카테고리, 색상, 기온, 격식도를 자동 완성합니다.
                  </span>
                </div>
              </div>
